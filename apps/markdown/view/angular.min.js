(function(T, U, t) {
    ...
    function oc(b, a) {
        ...
        return !u(a) || a instanceof RegExp ?
            a :
            c.length ?

            function() {
                return arguments.length ?
                    a.apply(b, c.concat(Ya.call(arguments, 0))) :
                    a.apply(b, c);
            } :
            function() {
    ...
    function S(b) {
        ...
        if (a) {
            a = U;
            var c;
            b = (c = cf.exec(b)) ? [a.createElement(c[1])] :
                (c = Ec(b, a)) ?
                c.childNodes : [];
        }
        Fc(this, b);
    ...
    function tb(b, a) {
        ...
        d &&
            (a ?
                delete d.data[a] :
                (d.handle && (d.events.$destroy && d.handle({}, "$destroy"), Gc(b)),
                    delete vb[c],
                    (b.ng339 = t)));
    }
    ...
    function ub(b, a) {
        ...
        a &&
            !c &&
            ((b.ng339 = c = ++df), (c = vb[c] = { events: {}, data: {}, handle: t }));
        return c;
    }
    ...
    function Vb(b, a, c) {
        ...
        if ("function" === typeof b) {
            if (!(d = b.$inject)) {
                ...
                if (b.length) {
                    if (a)
                        throw ((G(c) && c) || (c = b.name || hf(b)), Fa("strictdi", c));
            ...
            H(b) ?
            ((a = b.length - 1), ob(b[a], "fn"), (d = b.slice(0, a))) :
            ob(b, "fn", !0);
        return d;
    }
    ...
    function lf(b, a, c, d) {
        ...
        m.url = function(a, c, e) {
            ...
            if (a) {
                ...
                if (C !== a || (d.history && !f)) {
                    ...
                    J = e;
                    !d.history || (g && f) ?
                        (g || (N = a), c ? q.replace(a) : (q.href = a)) :
                        (n[c ? "replaceState" : "pushState"](e, "", a), h(), (J = I));
                    return m;
                }
        ...
        m.cookies = function(a, b) {
            ...
            if (a)
                ...
                if (p.cookie !== y)
                    for (
                        y = p.cookie, d = y.split("; "), ba = {}, f = 0; f < d.length; f++
                    )
                        (e = d[f]),
                        (g = e.indexOf("=")),
                        0 < g &&
                        ((a = l(e.substring(0, g))),
                            ba[a] === t && (ba[a] = l(e.substring(g + 1))));
                return ba;
            }
        };
    ...
    function vc(b, a) {
        ...
        this.$get = [
            ...
            "$animate",
            "$$sanitizeUri",
            function(a, b, c, s, O, D, x, B, K, E, I) {
                function J(a, b) {
                    try {
                        a.addClass(b);
                    } catch (c) {}
                ...
                function C(a, b, c, d, e) {
                    ...
                    return function(b, c, d) {
                        ...
                        g ||
                            (g = (d = d && d[0]) ?
                                "foreignobject" !== sa(d) && d.toString().match(/SVG/) ?
                                "svg" :
                                "html" :
                                "html");
                        d =
                            "html" !== g ?
                            z(T(g, z("<div>").append(a).html())) :
                            c ?
                            La.clone.call(a) :
                            a;
                        if (k)
                ...
                function ca(a, b, c, d, e, f) {
                    function g(a, c, d, e) {
                        var f, h, l, q, n, p, B;
                        if (s)
                            for (B = Array(c.length), q = 0; q < k.length; q += 3)
                                (f = k[q]), (B[f] = c[f]);
                        else B = c;
                        q = 0;
                        for (n = k.length; q < n;)
                            ...
                            c ?
                            (c.scope ?
                                ((l = a.$new()), C.$$addScopeInfo(z(h), l)) :
                                (l = a),
                                (p = c.transcludeOnThisElement ?
                                    N(a, c.transclude, e, c.elementTranscludeOnThisElement) :
                    ...
                    for (var k = [], h, l, q, n, s, p = 0; p < a.length; p++) {
                        h = new V();
                        l = W(a[p], [], h, 0 === p ? d : t, e);
                        (f = l.length ? ba(l, a[p], h, b, c, null, [], [], f) : null) &&
                        f.scope &&
                            C.$$addScopeClass(h.$$element);
                        h =
                ...
                function W(b, c, g, k, h) {
                    ...
                    switch (b.nodeType) {
                        case ka:
                            fa(c, xa(sa(b)), "E", k, h);
                            for (
                                var n, s, B, O = b.attributes, D = 0, K = O && O.length; D < K; D++
                            ) {
                                var I = !1,
                                    J = !1;
                                n = O[D];
                                ...
                                a: {
                                    ...
                                    if (d.hasOwnProperty(E)) {
                                        C = void 0;
                                        for (
                                            var E = a.get(E + "Directive"), r = 0, ca = E.length; r < ca; r++
                                        )
                                ...
                                C &&
                                    s === x + "Start" &&
                                    ((I = q),
                                        (J = q.substr(0, q.length - 5) + "end"),
                                        (q = q.substr(0, q.length - 6)));
                                s = xa(q.toLowerCase());
                                l[s] = q;
                                if (B || !g.hasOwnProperty(s))
                                    (g[s] = n), Kc(b, s) && (g[s] = !0);
                                S(b, c, n, s, B);
                                fa(c, s, "A", k, h, I, J);
                            }
                        ...
                        case 8:
                            try {
                                if ((q = e.exec(b.nodeValue)))
                                    (s = xa(q[1])), fa(c, s, "M", k, h) && (g[s] = P(q[2]));
                            } catch (W) {}
                    }
                    c.sort(v);
                    return c;
                ...
                function ba(a, d, e, f, g, k, l, s, p) {
                    ...
                    function I(a, c, f, g, k) {
                        ...
                        if (N) {
                            C.$$addScopeInfo(
                                W,
                                J, !0, !(ba && (ba === N || ba === N.$$originalDirective))
                            );
                            C.$$addScopeClass(W, !0);
                            g = ca && ca[N.name];
                            var X = J;
                                ...
                                switch (a.mode) {
                                    ...
                                    case "=":
                                        ...
                                        f = a.collection ?
                                            ...
                                            c.$watch(O(Q[e], f), null, k.literal);
                                        J.$on("$destroy", f);
                                        break;
                                    case "&":
                                        (k = O(Q[e])),
                        ...
                        for (n = l.length; g < n; g++)
                            ...
                            $(
                                ...
                                W,
                                Q,
                                p.require && K(p.directiveName, p.require, W, x),
                                cb
                            );
                        var Wb = c;
                    ...
                    for (
                        var J = -Number.MAX_VALUE,
                            ...
                            ba = p.templateDirective,
                            fa = p.nonTlbTranscludeDirective,
                            A = !1,
                            Oa = !1,
                            F = p.hasElementTranscludeDirective,
                            Y = (e.$$element = z(d)),
                            L,
                            ga,
                            v,
                        ...
                        if ((v = L.scope))
                            L.templateUrl ||
                            (M(v) ?
                                (za("new/isolated scope", N || x, L, Y), (N = L)) :
                                za("new/isolated scope", N, L, Y)),
                            (x = x || L);
                        ga = L.name;
                        !L.templateUrl &&
                            L.controller &&
                            ((v = L.controller),
                                (E = E || {}),
                                za("'" + ga + "' controller", E[ga], L, Y),
                                (E[ga] = L));
                        if ((v = L.transclude))
                            (A = !0),
                            L.$$tlb || (za("transclusion", fa, L, Y), (fa = L)),
                            "element" == v ?
                            ((F = !0),
                                (J = L.priority),
                                (v = Y),
                                (Y = e.$$element =
                                    z(U.createComment(" " + ga + ": " + e[ga] + " "))),
                                (d = Y[0]),
                                zb(g, Ya.call(v, 0), d),
                                (Ha = C(v, f, J, k && k.name, {
                        ...
                        if (L.template)
                            if (
                                ((Oa = !0),
                                    za("template", ba, L, Y),
                                    (ba = L),
                                    (v = u(L.template) ? L.template(Y, e) : L.template),
                                    (v = Pc(v)),
                                    L.replace)
                            ) {
                                k = L;
                        ...
                        if (L.templateUrl)
                            ...
                            (ba = L),
                            L.replace && (k = L),
                            (I = mf(a.splice(S, a.length - S), Y, e, g, A && Ha, l, s, {
                            ...
                            try {
                                (R = L.compile(Y, e, Ha)),
                                u(R) ? B(null, R, yb, aa) : R && B(R.pre, R.post, yb, aa);
                            } catch (da) {
                                c(da, va(Y));
                            }
                ...
                function mf(a, b, c, d, e, f, g, k) {
                    ...
                    s(K.getTrustedResourceUrl(O)).then(function(s) {
                        ...
                        if (n.replace) {
                            ...
                            I = s[0];
                            if (1 != s.length || I.nodeType !== ka)
                                throw ia("tplrt", n.name, O);
                            s = { $attr: {} };
                            zb(d, b, I);
                            var x = W(I, [], s);
                            M(n.scope) && y(x);
                        ...
                        for (q = ca(b[0].childNodes, e); h.length;) {
                            ...
                            if (!s.$$destroyed) {
                                if (K !== p) {
                                    var Q = K.className;
                                    (k.hasElementTranscludeDirective && n.replace) || (x = Qb(I));
                                    zb(E, z(K), x);
                                    J(z(x), Q);
                                }
                    ...
                    if (a)
                        for (g = 0, k = a.length; g < k; g++)
                            if (a[g] == d) {
                                a[g++] = c;
                                k = g + e - 1;
                                for (var h = a.length; g < h; g++, k++)
                                    k < h ? (a[g] = a[k]) : delete a[g];
                                a.length -= e - 1;
                ...
                V.prototype = {
                    ...
                    $set: function(a, b, d, e) {
                        ...
                        e
                            ?
                            (this.$attr[a] = e) :
                            (e = this.$attr[a]) || (this.$attr[a] = e = Lb(a, "-"));
                        g = sa(this.$$element);
                ...
                var Oa = b.startSymbol(),
                    ...
                    la :
                    function(a) {
                        return a.replace(/\{\{/g, Oa).replace(/}}/g, ga);
                    },
                    Aa = /^ngAttr[A-Z]/;
                C.$$addBindingInfo = l ?
    ...
    function Ce() {
        ...
        this.$get = [
            ...
            function(d, e) {
                function f(a, b, c, d) {
                    if (!a || !M(a.$scope)) throw v("$controller")("noscp", d, b);
                    a.$scope[b] = c;
                }
                    ...
                    G(g) &&
                        ((l = g.match(c)),
                            ...
                            (g = b.hasOwnProperty(p) ?
                                b[p] :
                                uc(h.$scope, p, !0) || (a ? uc(e, p, !0) : t)),
                            ob(g, p, !0));
                    if (k)
                        return (
                            (k = function() {}),
                            (k.prototype = (H(g) ? g[g.length - 1] : g).prototype),
                            (m = new k()),
                            q && f(h, q, m, p || g.name),
                            F(
                                function() {
            ...
            function(d, e, f, g, h, k) {
                        ...
                        e = (function(a) {
                            ...
                            a: for (e in c) {
                                ...
                                (function(a) {
                                    var b;
                                    r(a, function(c, d) {
                                        u(c) && ((b = c()), null != b ? (a[d] = b) : delete a[d]);
                                    });
                                })(d);
                            return d;
                        })(a);
                ...
                function m(c, f, k) {
                    function n(b, c, d, e) {
                        ...
                        J &&
                            (200 <= b && 300 > b ? J.put(r, [b, c, Tc(d), e]) : J.remove(r));
                    ...
                    !1 === c.cache ||
                        ...
                        (J = M(c.cache) ? c.cache : M(b.cache) ? b.cache : q);
                    if (J)
                        if (((C = J.get(r)), y(C))) {
                    ...
                    w(C) &&
                        ((C = Wc(c.url) ?
                                ...
                                t) && (k[c.xsrfHeaderName || b.xsrfHeaderName] = C),
                            d(
                                c.method,
                                r,
                                f,
    ...
    function uf(b, a, c, d, e) {
        ...
        return function(e, h, k, l, m, p, q, n) {
            ...
            if ("jsonp" == R(e)) {
                ...
                var x = f(
                    h.replace("JSON_CALLBACK", "angular.callbacks." + D),
                    D,
                    function(a, b) {
                        O(l, a, d[D].data, "", b);
                        d[D] = A;
        ...
        this.$get = [
            ...
            function(c, d, e) {
                ...
                function g(f, g, n, s) {
                    ...
                    s = !!s;
                    for (
                        var x, B, K = 0, E = [], I = [], J = f.length, C = [], r = []; K < J;

                    )
                        if (-1 != (x = f.indexOf(b, K)) && -1 != (B = f.indexOf(a, x + h)))
                            K !== x && C.push(O(f.substring(K, x))),
                            (K = f.substring(x + h, B)),
                            E.push(K),
                            I.push(c(K, D)),
                            (K = B + k),
                    ...
                    if (n && 1 < C.length) throw Zb("noconcat", f);
                    if (!g || E.length) {
                        var N = function(a) {
            ...
            function(b, a, c, d) {
                function e(e, h, k, l) {
                    ...
                    O.$$intervalId = m(function() {
                        ...
                        0 < k &&
                            q >= k &&
                            (s.resolve(q), p(O.$$intervalId), delete f[O.$$intervalId]);
                        n || b.$apply();
                    }, h);
                    f[O.$$intervalId] = s;
                    return O;
    ...
    function Je() {
        ...
        this.html5Mode = function(b) {
            return Va(b) ?
                ((a.enabled = b), this) :
                M(b) ?
                (Va(b.enabled) && (a.enabled = b.enabled),
                    Va(b.requireBase) && (a.requireBase = b.requireBase),
                    Va(b.rewriteLinks) && (a.rewriteLinks = b.rewriteLinks),
                    this) :
                a;
        };
        this.$get = [
            ...
            function(c, d, e, f) {
                ...
                d.onUrlChange(function(a, b) {
                    c.$evalAsync(function() {
                        ...
                        k.$$parse(a);
                        k.$$state = b;
                        c.$broadcast("$locationChangeStart", a, d, b, e).defaultPrevented ?
                    ...
                    if (n || l)
                        ...
                        c.$evalAsync(function() {
                            c.$broadcast(
                                ...
                                (k.$$parse(a), (k.$$state = b)) :
                                (l && g(k.absUrl(), f, b === k.$$state ? null : k.$$state),
                                    h(a, b));
                        });
                    k.$$replace = !1;
                });
                        ...
                        case "string":
                            ...
                            r ||
                                (":" === d.charAt(0) &&
                                    ...
                                    (g = g ? n : q),
                                    (r = new fc(g)),
                                    (r = new eb(r, c, g).parse(d)),
                                    r.constant ?
                                    (r.$$watchDelegate = m) :
                                    B ?
                                    ((r = e(r)), (r.$$watchDelegate = r.literal ? l : k)) :
                                    r.inputs && (r.$$watchDelegate = h),
                                    (E[K] = r));
                            return p(r, f);
                        case "function":
                            return p(d, f);
            ...
            function(e, f, g, h) {
                ...
                k.prototype = {
                    ...
                    $watch: function(a, b, d) {
                        ...
                        var f = this.$$watchers,
                            k = { fn: b, last: p, get: e, exp: a, eq: !!d };
                        c = null;
                        u(b) || (k.fn = A);
                        f || (f = this.$$watchers = []);
                        f.unshift(k);
                    ...
                    $digest: function() {
                        ...
                        do {
                            ...
                            if ((r || O.length) && !x--)
                                throw ((s.$$phase = null), a("infdig", b, ua(t)));
                        } while (r || O.length);
                        for (s.$$phase = null; D.length;)
                            try {
                                D.shift()();
                            } catch (A) {
                                f(A);
                    ...
                    $broadcast: function(a, b) {
                        ...
                        for (var g = kb([e], arguments, 1), k, h;
                            (c = d);) {
                            e.currentScope = c;
                            d = c.$$listeners[a] || [];
                            k = 0;
                ...
                if (k) {
                    ...
                    !d ||
                        ...
                        ((l = G(f.body.style.webkitTransition)),
                            (m = G(f.body.style.webkitAnimation)));
                }
                return {
        ...
        return function(a, c, d) {
            ...
            function f(a, b) {
                var c = typeof a,
                    d = typeof b;
                return c == d ?
                    (ea(a) && ea(b) && ((a = a.valueOf()), (b = b.valueOf())),
    ...
    function fb(b, a, c, d, e, f) {
        ...
        var m = function(b) {
            if (!l) {
                var e = a.val(),
                    f = b && b.type;
                Ia && "input" === (b || h).type && a[0].placeholder !== g ?
                    (g = a[0].placeholder) :
                    ("password" === k ||
    ...
    function qd(b, a, c, d) {
        (d.$$hasNativeValidators = M(a[0].validity)) &&
    ...
    function pd(b) {
        ...
        d.$setValidity = function(b, e, f) {
            ...
            d.$pending ?
                (a(ud, !0), (d.$valid = d.$invalid = t), c("", null)) :
                (a(ud, !1),
                    (d.$valid = td(d.$error)),
                    (d.$invalid = !d.$valid),
                    c("", d.$valid));
    ...
    var Ze = /([\:\-\_]+(.))/g,
        $e = /^moz([A-Z])/,
        Mf = { mouseleave: "mouseout", mouseenter: "mouseover" },
        Pb = v("jqLite"),
        cf = /^<(\w+)\s*\/?>(?:<\/\1>|)$/,
        Ob = /<|&#?\w+;/,
        af = /<([\w:]+)/,
    ...
    var La = (S.prototype = {
            ready: function(b) {
                ...
                "complete" === U.readyState ?
                    setTimeout(a) :
                    (this.on("DOMContentLoaded", a), S(T).on("load", a));
            },
            toString: function() {
                var b = [];
                r(this, function(a) {
    ...
    r({
            ...
            scope: function(b) {
                return (
                    z.data(b, "$scope") ||
                    wb(b.parentNode || b, ["$isolateScope", "$scope"])
                );
            },
    ...
    r({
            ...
            on: function a(c, d, e, f) {
                ...
                if (Dc(c)) {
                    ...
                    h || (h = g.handle = gf(c, f));
                    for (
                        var g = 0 <= d.indexOf(" ") ? d.split(" ") : [d], k = g.length; k--;
                        ...
                        return {
                            ...
                            setClass: function(a, c, d, e) {
                                ...
                                m
                                    ...
                                    e &&
                                    m.options &&
                                    (m.options = wa.extend(m.options || {}, e)) :
    ...
    var of = /^((?:x|data)[\:\-_])/i,
        Sc = "application/json",
        Yb = { "Content-Type": Sc + ";charset=utf-8" },
        rf = /^\s*(\[|\{[^\{])/,
        sf = /[\}\]]\s*$/,
        qf = /^\)\]\}',?\n/,
        Zb = v("$interpolate"),
            ...
            search: function(a, c) {
                switch (arguments.length) {
                    case 0:
                        return this.$$search;
                    case 1:
                        if (G(a) || V(a))(a = a.toString()), (this.$$search = rc(a));
                        else if (M(a))
                            (a = Da(a, {})),
                            r(a, function(c, e) {
                                null == c && delete a[e];
    ...
    fc.prototype = {
        ...
        readIdent: function() {
            for (
                var a = this.text, c = "", d = this.index, e, f, g, h; this.index < this.text.length;
    ...
    eb.prototype = {
        ...
        unary: function() {
            ...
            return this.expect("+") ?
                this.primary() :
                (a = this.expect("-")) ?
                this.binaryFn(eb.ZERO, a.fn, this.unary()) :
                (a = this.expect("!")) ?
        ...
        functionCall: function(a, c) {
            ...
            return function(g, h) {
                ...
                if (l) {
                    ...
                    if (l === Qf || l === Rf || l === Sf) throw qa("isecff", e);
                }
            ...
            return {
                ...
                link: function(d, e, f) {
                    var g = a,
                        h = a;
                    "href" === a &&
                        "[object SVGAnimatedString]" === Ka.call(e.prop("href")) &&
                        ((h = "xlinkHref"), (f.$attr[h] = "xlink:href"), (g = null));
                    f.$observe(c, function(c) {
                        c
                            ?
                            (f.$set(h, c), Ia && g && e.prop(g, f[h])) :
                            "href" === a && f.$set(h, null);
                    });
                },
            };
    ...
    var vd = function(a) {
        ...
        Ad = {
            ...
            "datetime-local": gb(
                "datetimelocal",
                xd,
                Fb(xd, "yyyy MM dd HH mm ss sss".split(" ")),
        ...
        Yf = [
            ...
            function(a, c, d, e, f, g, h, k, l, m) {
                ...
                var p = f(d.ngModel),
                    ...
                    O = function(c) {
                        var d;
                        n.$options && n.$options.getterSetter && u((d = p(a))) ?
                            d(n.$modelValue) :
                            p.assign(a, n.$modelValue);
                    };
                this.$$setOptions = function(a) {
                    n.$options = a;
                    if (!(p.assign || (a && a.getterSetter)))
                        throw Gb("nonassign", d.ngModel, va(e));
                };
                this.$render = A;
                ...
                this.$validate = function() {
                    (V(n.$modelValue) && isNaN(n.$modelValue)) ||
                ...
                a.$watch(function() {
                    ...
                    if (a !== n.$modelValue) {
                        ...
                        n.$viewValue !== e &&
                            ((n.$viewValue = n.$$lastCommittedViewValue = e),
                                n.$render(),
                                n.$$runValidators(t, a, e, A));
                    }
                    return a;
                });
            },
        ...
        yc = function() {
            return {
                ...
                link: function(a, c, d, e) {
                    e &&
                        ((d.required = !0),
                            (e.$validators.required = function(a) {
                        ...
                        this.$options.updateOn !== t ?
                            ((this.$options.updateOnDefault = !1),
                                (this.$options.updateOn = P(
                                    this.$options.updateOn.replace(Xf, function() {
            ...
            function(a, c) {
                ...
                return {
                    ...
                    link: function(e, f, g) {
                        ...
                        r(g, function(a, c) {
                            s.test(c) &&
                                (m[R(c.replace("when", "").replace("Minus", "-"))] = f.attr(
                                    g.$attr[c]
                                ));
                        });
                        r(m, function(a, e) {
                        ...
                        return function(a, f, g, l, n) {
                            ...
                            a.$watchCollection(p, function(g) {
                                ...
                                if (Sa(g))(H = g), (p = x || B);
                                    ...
                                    H = [];
                                    for (G in g)
                                        g.hasOwnProperty(G) && "$" != G.charAt(0) && H.push(G);
                                    H.sort();
                                }
                                A = H.length;
                                G = Array(A);
                                ...
                                for (l = 0; l < A; l++)
                                    if (
                                        ((D = g === H ? l : H[l]), (w = g[D]), (u = G[l]), u.scope)
                                    ) {
                                        v = C;
                                        do v = v.nextSibling;
                ...
                return {
                    ...
                    link: function(e, g, h, k) {
                        ...
                        function m(a, c, d) {
                            ...
                            a.$watch(function() {
                                ma(e, d.$viewValue) || ((e = ta(d.$viewValue)), d.$render());
                            });
                            c.on("change", function() {
                                a.$apply(function() {
                                    var a = [];
                                ...
                                for (A = c.length; w < A; w++) {
                                    ...
                                    for (H = l.length; D < H; D++)
                                        ...
                                        ("" === d.id && v ?
                                            ...
                                            m(Q, d.label, !0),
                                            P ? P.after(U) : s.element.append(U),
                                            (P = U));
                                    for (D++; t.length > D;)
                                        (d = t.pop()), m(Q, d.label, !1), d.element.remove();
                                    r(Q, function(a, c) {
